...
export const ChatTabAutoLayout = memo(() => {
  const onReady = useCallback<IGridviewReactProps['onReady']>(({ api }) => {
    initializeRootPanelLayout('chat', api);
  }, []);

  useEffect(
    () => () => {
      navigationApi.unregisterTab('chat');
    },
    []
  );

  return (
    <AutoLayoutProvider tab="chat">
      <GridviewReact
        className="dockview-theme-invoke"
...
ChatTabAutoLayout.displayName = 'ChatTabAutoLayout';
