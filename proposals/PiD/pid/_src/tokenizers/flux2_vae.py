...
class Flux2VAE:
    ...
    def __init__(
        ...
        if vae_pth is None:
            import os
            default_path = "/mnt/workplace/ai/SD/models/PiD/PiD_flux2_ae.safetensors"
            vae_pth = default_path if os.path.exists(default_path) else "./checkpoints/flux2_ae.safetensors"
        self.dtype = dtype
        self.device = device
        self.scale = None
