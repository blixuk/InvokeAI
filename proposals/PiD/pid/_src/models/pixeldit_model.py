...
_TEXT_ENCODER_DICT = {
    ...
    "gemma-2-2b-it-abliterated": "IlyaGusev/gemma-2-2b-it-abliterated",
...
def _load_text_encoder(name: str, device: str = "cuda"):
    ...
    causal_lm = AutoModelForCausalLM.from_pretrained(model_id, torch_dtype=torch.bfloat16)
    text_encoder = causal_lm.get_decoder()
    if text_encoder is None:
        text_encoder = getattr(causal_lm, "model", causal_lm)
